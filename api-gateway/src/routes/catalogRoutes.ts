...
function setupCatalogRoutes(app: express.Express) {
    ...
    app.get("/catalog/restaurants/ownerId/:ownerId",authCheck([Role.COMMERCIAL, Role.TECHNIC, Role.OWNER]), catalogProxy);
    app.post("/catalog/restaurants/", authCheck([Role.COMMERCIAL, Role.TECHNIC, Role.OWNER]), catalogProxy);
    ...
    app.delete("/catalog/restaurants/:restaurantId/menus/:menuId/", authCheck([Role.COMMERCIAL, Role.TECHNIC, Role.OWNER]), catalogProxy);
}
